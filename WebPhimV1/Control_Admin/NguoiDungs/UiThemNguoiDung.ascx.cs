...
namespace WebPhimV1.Control_Admin.NguoiDungs
{
    public partial class UiThemNguoiDung : System.Web.UI.UserControl
    {
        ...
        {
            var dt = (from q in dl.DB_USERs
                      where q.ten_dangnhap == taikhoan.Text ||
                          q.mail == email.Text
                      select q);
            ...
            else
            {
                ...
                dts.ten_dangnhap =
                    HeThong.LocKyTuDatBiet(HeThong.LocDauTiengViet(taikhoan.Text));
                dts.ma_khoa = HeThong.MH_MD5(taikhoan.Text + matkhau.Text);
                dts.mail = email.Text;
                dts.coin = Convert.ToInt32(coin.Text);
                dts.matkhau_user = HeThong.MH_MD5(
                    HeThong.LocKyTuDatBiet(HeThong.LocDauTiengViet(matkhau.Text)));
                ...
                ScriptManager.RegisterClientScriptBlock(
                    ...
                    "alert('Thêm người dùng thành công')", true);
            }
        }
