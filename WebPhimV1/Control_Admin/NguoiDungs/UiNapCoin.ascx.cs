    ...
    public partial class UiNapCoin : System.Web.UI.UserControl
    {
        ...
        protected void Themcoin_Click(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                ...
                log.ghichu =
                    NguoiDungs.fullname + "_Nap_Coin_" + Thongtinnapcoin.fullname;
                ...
                string noidung = " Bạn nhận được " + naptien.ToString() + " coin từ " +
                                 NguoiDungs.fullname;
                string urls = "taikhoan/info#giaodich";
                NguoiDung.ThemThongBao(Thongtinnapcoin.id_user, NguoiDungs.id_user,
                                       noidung, urls);

                string scriptText =
                    "alert('Giao dịch thành công !'); window.location='" +
                    Request.ApplicationPath + "cp-admin/nguoidung/Napcoin-" +
                    Thongtinnapcoin.id_user + "'";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "xoaPhim",
                                                    scriptText, true);
                // Response.Redirect("~/cp-admin/nguoidung/Napcoin-" +
                // Thongtinnapcoin.id_user);
            }
        }
        ...
        protected void Giamcoin_Click(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                ...
                dl.SubmitChanges();
                // thong bao cap nhat Tap_Phim
                string noidung = NguoiDungs.fullname + " Giảm " + naptien.ToString() +
                                 " coin của bạn";
                string urls = "taikhoan/info#giaodich";
                NguoiDung.ThemThongBao(Thongtinnapcoin.id_user, NguoiDungs.id_user,
                                       noidung, urls);
                ...
                // "alertMessage", "alert('Hiến máu thành công')", true);
                // Response.Redirect("~/cp-admin/nguoidung/Napcoin-" +
                // Thongtinnapcoin.id_user);
            }
        }
