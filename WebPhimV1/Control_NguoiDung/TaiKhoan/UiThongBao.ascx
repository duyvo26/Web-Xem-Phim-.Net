         ...
         <div class="notification-list notification-list--unread" onclick="window.location='?id=<%=ThongBaos[i].id %>'">
            <div class="notification-list_content" title="#<%=ThongBaos[i].id_user_phanhoi %>">
               <div class="notification-list_img" >
                  ...
                  <img onError="this.onerror=null;this.src='<%=WebPhimV1.Code.HeThong.url() %>/public/img/www/err-img.png';"
      ...
      <div class="text-center">
         ...
         <div class="d-flex justify-content-center">
            <nav aria-label="Page navigation example">
               <ul class="pagination">
                  <%if (ThongBaos.Count > 0 && SumPage > 0) { for (int i = 0; i <= SumPage; i++) { %>
...
<style>
   .section-50{padding:50px 0}.m-b-50{margin-bottom:50px}.dark-link{color:#333}.heading-line{position:relative;padding-bottom:5px}.heading-line:after{content:"";height:4px;width:75px;background-color:#29b6f6;position:absolute;bottom:0;left:0}.notification-ui_dd-content{margin-bottom:30px}.notification-list{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;padding:20px;margin-bottom:7px;background:#fff;-webkit-box-shadow:0 3px 10px rgba(0,0,0,.06);box-shadow:0 3px 10px rgba(0,0,0,.06)}.notification-list--unread{border-left:4px solid #f62929}.notification-list .notification-list_content{display:-webkit-box;display:-ms-flexbox;display:flex}.notification-list .notification-list_content .notification-list_img img{height:48px;width:48px;border-radius:50px;margin-right:20px}.notification-list .notification-list_content .notification-list_detail p{margin-bottom:5px;line-height:1.2}.notification-list .notification-list_feature-img img{height:48px;width:48px;border-radius:5px;margin-left:20px}
</style>