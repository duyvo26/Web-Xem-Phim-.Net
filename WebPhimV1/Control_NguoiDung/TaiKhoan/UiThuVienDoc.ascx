...
<div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl-3" style="padding: 10px">
   ...
   <div class=" card epi-img position-relative" style="background: var(--iq-primary) !important;  padding: 1px;">
      ...
      <div class=" card epi-img position-relative">
         ...
         <a title="<%=TenTap_Phim(Convert.ToInt32(ThuVien[a].id_tap_phim)) %>" href="<%=WebPhimV1.Code.HeThong.url() %>/Phim/<%=ThuVien[a].link_raw + "-" + ThuVien[a].id_phim + "/" + ThuVien[a].id_tap_phim %>">
            <div class="tenTap_Phim"><%= WebPhimV1.Code.Phim.RutGon(TenTap_Phim(Convert.ToInt32(ThuVien[a].id_tap_phim)), 20) %></div>
         </a>
