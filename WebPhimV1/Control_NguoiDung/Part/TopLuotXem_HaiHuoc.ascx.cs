...
{
    public partial class TopLuotXem_HaiHuoc : System.Web.UI.UserControl
    {
        ...
        public string TenTheLoai(int IDPhim)
        {
            ...
            foreach (var i in dt)
            {
                if (HeThong.LocDauTiengViet(i.ten_theloai).ToLower() == HeThong.LocDauTiengViet("hài hước").ToLower())
                {
