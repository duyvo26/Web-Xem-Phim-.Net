<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TopLuotXem_HaiHuoc.ascx.cs" Inherits="WebPhimV1.Control_NguoiDung.Part.TopLuotXem_HaiHuoc" %>
<section id="tophaihuoc">
   <div class="container-fluid">
      <div class="row">
         <div class="col-sm-12 overflow-hidden">
            <div class="iq-main-header d-flex align-items-center justify-content-between">
               <h4 class="main-title"><a href="#tophaihuoc"><i class="fa-solid fa-mushroom"></i>&nbsp;Top Phim Hài Hước </a></h4>
            </div>
