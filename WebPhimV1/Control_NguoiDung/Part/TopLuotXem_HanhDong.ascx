<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TopLuotXem_HanhDong.ascx.cs" Inherits="WebPhimV1.Control_NguoiDung.Part.TopLuotXem_HanhDong" %>

<section id="tophanhdong">
   <div class="container-fluid">
      <div class="row">
         <div class="col-sm-12 overflow-hidden">
            <div class="iq-main-header d-flex align-items-center justify-content-between">
               <h4 class="main-title"><a href="#tophanhdong"><i class="fa-solid fa-gun"></i>&nbsp;Top Phim Hành Động </a></h4>
            </div>
